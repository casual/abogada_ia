...
def run_writing(escrito: str):
    ...
    prompt = "Piensa en una estrategia para el siguiente caso: " + escrito
...
def setup_strategy():
    st.title("Estrategia")
    st.subheader("Pensar en estrategias legales", help = "Describe tu caso y te entregaré una estrategia", divider = "gray") 
